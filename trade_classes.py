...
class Trade:
    ...
    def overview(self):
        ...
        if self.status == 'active':
            ...
            ov_string = 'Closing Trade: ' + self.pair + ' | ' + str(self.id) + ' | TimeStarted: ' + time_started + ' | TimeFinished: ' + str(latest_update) + ' | LongestUpdate: ' + str(self.largest_update/60000) + 'm | Status: ' + self.status + '\n'
        return ov_string
